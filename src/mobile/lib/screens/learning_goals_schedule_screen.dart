...
class _LearningGoalsScheduleScreenState
  ...
  Future<void> _editPurpose() async {
    final value = await showModalBottomSheet<String>(
      ...
      showDragHandle: true,
      isScrollControlled: true,
      builder: (context) => _PurposeBottomSheet(
        initialPurpose: _profile?.learningPurpose,
      ),
    );
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              l10n.translate('profile.save_failed'),
            ),
          ),
        );
      }
                  ...
                  children: [
                    ...
                    _group(
                      ...
                      [
                        _SettingTile(
                          title: l10n
                              .translate('profile.settings.study_reminder'),
                          value: _reminder,
                          onChanged: _isSaving
                              ? null
                              : (value) => _toggle(
                        ...
                        _SettingTile(
                          title:
                              l10n.translate('profile.settings.reminder_time'),
