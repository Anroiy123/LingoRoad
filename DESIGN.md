...
- The five Task 3 Figma states link to twelve reviewed `progress-profile/` rasters generated by the pinned Ubuntu runner. `pendingGoldenBaselines` is empty, and the manifest validator requires both light and dark files for every linked Task 3 state.
